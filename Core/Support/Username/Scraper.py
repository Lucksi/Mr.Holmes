...
from Core.Support.Username import Get_Photos
...
class info:
    ...
    def Instagram(report, username, http_proxy):
        ...
        if Blocked in text:
            print(Font.Color.RED + "[!]" + Font.Color.WHITE +
                  "LOOKS LIKE THIS USER IS PRIVATE..CANNOT SCRAPE DATA")
            pass
        else:
            ...
            if Photos == 1:
                ...
                Get_Photos.Downloader.Instagram(username, http_proxy, Posts)
            else:
                pass
    ...
    def Nitter(report, username, http_proxy):
        ...
        if Blocked in text:
            print(Font.Color.RED + "[!]" + Font.Color.WHITE +
                  "LOOKS LIKE THIS USER HAS BEEN BANNED..CANNOT SCRAPE DATA")
            pass
        else:
            reader = soup(openurl.content, "html.parser")
