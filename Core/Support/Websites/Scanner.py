...
class Port:
    ...
    def Get_Port(Server, report, port, Open_Ports):
        ...
        if Result == 0:
            print(Font.Color.YELLOW + "[v]" + Font.Color.WHITE +
                  "THIS PORT IS: " + Font.Color.GREEN + "OPEN")
            ...
            print(Font.Color.RED + "[!]" + Font.Color.WHITE +
                  "THIS PORT IS: " + Font.Color.RED + "CLOSED")
        host.close()
    ...
    def Scan(username, report):
        ...
        print(Font.Color.GREEN + "\n[+]" + Font.Color.WHITE +
              "CHECKING PORTS OF: {}".format(username))
        print(Font.Color.GREEN +
        ...
        if nPorts == 1:
            ...
            while Min == "":
                Min = int(input(Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + "INSERT THE PORT NUMBER TO START WITH\n\n" +
                                Font.Color.GREEN + "[#MR.HOLMES#]" + Font.Color.WHITE + "-->"))
            Max2 = int(input(Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + "INSERT THE PORT NUMBER TO FINISH WITH\n\n" +
                             Font.Color.GREEN + "[#MR.HOLMES#]" + Font.Color.WHITE + "-->"))
            while Max2 == "":
                Max2 = int(input(Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + "INSERT THE PORT NUMBER TO FINISH WITH\n\n" +
                                 Font.Color.GREEN + "[#MR.HOLMES#]" + Font.Color.WHITE + "-->"))
        ...
        try:
            ...
            print(Font.Color.RED +
                  "[!]" + Font.Color.WHITE + "COULD NOT COMUNICATE WITH HOST")
        if len(Open_Ports):
            print(Font.Color.GREEN + "\n[+]" + Font.Color.WHITE +
                  "PRINTING OPEN PORTS FOR: {}".format(username))
            sleep(4)
            ...
            print(Font.Color.RED + "\n[!]" + Font.Color.WHITE +
                  "OPS LOOKS LIKE THERE IS NO OPEN PORTS FOR: {}".format(username))
