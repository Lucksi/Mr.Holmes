            ...
            try:
                ...
                if sce == 1:
                    print(Font.Color.RED + "\n[!]" + Font.Color.WHITE +
                          "ATTENTION SOME OF THE RESULTS MAY BE FALSE POSITIVES")
                    username = str(input(
                    ...
                    username = str(input(Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + "INSERT A DOMAIN OR A IP ADDRESS(IPv4/IPv6)" +
                                   Font.Color.GREEN + "\n\n[#MR.HOLMES#]" + Font.Color.WHITE + "-->"))
                    while username == "":
                        username = str(input(Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + "INSERT A DOMAIN OR A IP ADDRESS(IPv4/IPv6)" +
                                       Font.Color.GREEN + "\n\n[#MR.HOLMES#]" + Font.Color.WHITE + "-->"))
                    ...
                    username = input(Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + "INSERT A HOST TO SCAN" +
                                     Font.Color.GREEN + "\n\n[#MR.HOLMES#]" + Font.Color.WHITE + "-->")
                    while username == "":
                        username = str(input(Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + "INSERT A HOST TO SCAN " +
                                       Font.Color.GREEN + "\n\n[#MR.HOLMES#]" + Font.Color.WHITE + "-->"))
                    ...
                    username = input(Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + "INSERT A E-MAIL ADDRESS" +
                                     Font.Color.GREEN + "\n\n[#MR.HOLMES#]" + Font.Color.WHITE + "-->")
                    while username == "":
                        username = str(input(Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + "INSERT A E-MAIL ADDRESS " +
                                       Font.Color.GREEN + "\n\n[#MR.HOLMES#]" + Font.Color.WHITE + "-->"))
                    ...
                    print(Font.Color.RED + "[!]" + Font.Color.WHITE +
                          "LOOKS LIKE YOU HIT A WRONG OPTION EXIT...")
                    exit()
            except ValueError as e:
                print(Font.Color.RED + "[!]" + Font.Color.WHITE +
                      "LOOKS LIKE YOU HIT A WRONG OPTION EXIT...{}".format(str(e)))
                exit()
