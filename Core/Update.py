...
class Downloader:
    ...
    def Check_Creds():
        ...
        while Attempts > 0:
            Pass = str(input(
                Font.Color.BLUE + "INSERT YOUR UPDATE PASSWORD YOU HAVE {} ATTEMPTS".format(Attempts)))
            while Pass == "":
                Pass = str(input(
                    Font.Color.BLUE + "INSERT YOUR UPDATE PASSWORD YOU HAVE {} ATTEMPTS".format(Attempts)))
            if Pass == Password:
                ...
                print(Font.Color.BLUE +
                      "WRONG PASSWORD YOU HAVE {} ATTEMPTS".format(Attempts))
        inp = input(
            "YOU HAVE {} ATTEMPTS PRESS ENTER TO CONTINUE".format(Attempts))
