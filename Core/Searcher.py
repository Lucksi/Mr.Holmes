        ...
        for sites in data:
            for data1 in sites:
                ...
                if alert == "NOT-CORRECT":
                    print(
                        Font.Color.YELLOW2 + "[U]" + Font.Color.WHITE + "USERNAME FORMAT NOT VALID..SKIPPING")
                else:
                    try:
            ...
            if len(ScraperSites):
                ...
                if choice == 1:
                    ...
                    if choice == 1:
                        ...
                        content = access.read()
                        final = json.loads(content)
                        identity = "YOUR PROXY IP IS LOCATED IN: " + \
                            final["regionName"]
                    else:
                        http_proxy = None
                        http_proxy2 = str(http_proxy)
                ...
                print(Font.Color.RED + "\n[!]" + Font.Color.WHITE +
                      "OPS LOOKS LIKE THERE IS NO SITE TO SCRAPE...¯\_(ツ)_/¯")
        else:
            print(Font.Color.RED + "[!]" + Font.Color.WHITE +
                  "OPS LOOKS LIKE USERNAME: {} HAS NOT BEEN FOUND ON ANY WEBSITE..¯\_(ツ)_/¯".format(username))
        count = 1
        if count == 1:
            choice = int(input(
                Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + "WOULD YOU LIKE TO PERFORM A GOOGLE/YANDEX DORK SEARCH?(1)YES(2)NO\n\n" + Font.Color.GREEN + "[#MR.HOLMES#]" + Font.Color.WHITE + "-->"))
            if choice == 1:
